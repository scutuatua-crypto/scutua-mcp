        ...
        markets = [
            {
                ...
                "expiry": m.get("expiry"),
                "implied_apy": m.get("details", {}).get("impliedApy"),
                "liquidity_usd": m.get("details", {}).get("liquidity"),
                "aggregated_apy": m.get("details", {}).get("aggregatedApy"),
                "underlying_apy": m.get("details", {}).get("pendleApy"),
            }
            for m in results
        ]
